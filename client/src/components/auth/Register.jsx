    ...
    <div className="flex items-center justify-center min-h-[82vh] px-4 py-8">
      <div className="w-full max-w-md royal-glass p-8 rounded-3xl shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center space-y-2 mb-6">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-purple-600 via-amber-400 to-yellow-200 p-[1px] mx-auto shadow-xl shadow-purple-500/20">
          ...
          <p className="text-xs text-amber-200/60 font-medium">
            Register your name upon the Grand Royal Scroll
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {loading ? 'Inscribing Royal Scroll...' : 'Swear Allegiance 👑'}
          </button>
